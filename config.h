 ...
 */
static unsigned int mouseshape  = XC_left_ptr; // XC_xterm;
...
/* Externalpipe patch definitions (from Luke Smith's github)*/
...
/* From externalpipe's suckless wiki page */
static char* copyoutput[] = { "/bin/sh", "-c", "st-edout", "externalpipe", NULL };
